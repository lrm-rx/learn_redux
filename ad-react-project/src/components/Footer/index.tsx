...
class Footer extends PureComponent<IProps, IStates> {
  render() {
    return (
      <div className="footer-component-box">
        ...
        <div className="footer-copyright">©2022 Muke 使用慕课前必读 京公安网备 10100000号 互联网信息服务许可 我已阅读并接受慕课推广服务合同 欢迎访问慕课推广政策中心</div>
      </div>
    );
  }
}
